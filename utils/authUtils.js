...
export const setAuthToken = (token, cookie_name) => {
  ...
  expirationDate.setTime(expirationDate.getTime() + COOKIE_TIMEOUT_IN_MINUTES * 60 * 1000);

  Cookies.set(TOKEN_COOKIE_NAME, token, { expires: expirationDate, secure: true, sameSite: 'strict' });
};
